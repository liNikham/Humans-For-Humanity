...
2. Fork the repository by clicking on the ["Fork"](https://github.com/liNikham/Humans-For-Humanity/fork) button at the top right corner of the page.


3. Once you are in your fork the url should look something like
`https://github.com/<YOUR-USERNAME>/Humans-For-Humanity/`
...
- For HTTP
 ```
   git clone https://github.com/<YOUR-USERNAME>/Humans-For-Humanity.git
 ```
- For SSH
 ```bash
   git clone git@github.com:<YOUR-USERNAME>/Humans-For-Humanity.git
 ```

5. Now enter the folder by running the following command
```bash
cd Humans-For-Humanity
```

5. Now you are in the `Humans-For-Humanity` folder
...
>NOTE: Please make sure to follow the [Code of conduct](https://github.com/liNikham/Humans-For-Humanity/blob/b60808cd06dab29eb7664682c53919162a57d26c/CODE_OF_CONDUCT.md) while contributing.
