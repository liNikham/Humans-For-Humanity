...
class App extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("h2", null, "Thank you so much for filling in your details."), /*#__PURE__*/
      React.createElement("p", null, "You're almost towards the end."), /*#__PURE__*/
      React.createElement("p", null, "We would like to thank you for donating. Your donations will provide help support people in need."), /*#__PURE__*/
      ...
      gameOver && "Nice one",
      cursorGrabbed && "Pay Now!",
      !gameOver && !cursorGrabbed && "Click Me!"), /*#__PURE__*/
...
const GrabZone = ({ cursorGrabbed, gameOver, onCursorGrabbed }) => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("strong", null, "Thank You"), /*#__PURE__*/
